 ...
 */
@SpringBootTest(classes = ClienteApp.class)
...
public class ClienteResourceIT {
    ...
    public void createCliente() throws Exception {
        ...
        assertThat(testCliente.getCc()).isEqualTo(DEFAULT_CC);
    ...
    public void updateCliente() throws Exception {
        ...
        assertThat(testCliente.getCc()).isEqualTo(UPDATED_CC);
